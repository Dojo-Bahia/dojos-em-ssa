...
class LuhnTest(unittest.TestCase):
    ...
    def test_letter_is_invalid(self):
        self.assertIs(Luhn("0000a0").is_valid(), False)
    def test_letter_is_invalid(self):
        self.assertIs(Luhn("0000b0").is_valid(), False)
    ...
    def test_every_second_digit(self):
        self.assertIs(Luhn("0 55 44 42 86").is_every_second_digit(), [5, 4, 4, 8])
