...
/**
 * Para efeitos de CODE COMPLETION
 * 
 *  @method addContextMenuItem($label, $event, $eventData) - <b>Adds a new item to context menu.</b>
 *  @method makeToast($title, $msg) - <b>Shows a message in the screen.</b>
 * 
 */
...
class Android
{
   ...
   public function __construct($addr = null)
   {
      ...
      socket_connect($this->_socket, $addr, getenv('AP_PORT'));
      $this->_id = 0;
